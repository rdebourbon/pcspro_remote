...
/// </summary>
internal sealed class FakePeriodicTimer : PcsRemote.TrayHost.IPeriodicTimer
{
    ...
    /// <summary>
    /// Completes when the timer is disposed, meaning the loop has fully exited
    /// and the <c>await using</c> block called <see cref="DisposeAsync"/>.
    /// </summary>
