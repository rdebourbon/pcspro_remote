...
|---|---|---|---|---|
| OQ-1 | Exact Play-Cricket API status strings for *in-progress* and *completed* states. | Dev | Blocks S-007 (JIT Spec) | **Resolved** — Confirmed via Play-Cricket API v2 documentation during S-007 JIT Spec authoring. Completed statuses: `"Result"`, `"Abandoned"`, `"No Result"`. In-progress: `"Playing"`. Not-started: `"Fixture"`. Comparison is case-insensitive. |
